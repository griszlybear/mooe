...
<body>
    ...
    <div class="side-bar">
        ...
        <header>
            ...
            <h1>MOOE</h1>
            <h6>Accounting Unit <?php echo $firstName ?></h6>
        </header>
        <div class="menu">
            <div class="item"><a href="../accounting/accounting.php"><i class="fas fa-desktop"></i>Dashboard</a></div>
            <div class="item">
                <a class="sub-btn"><i class="fas fa-table"></i>Monitoring<i class="fas fa-angle-right dropdown"></i></a>
                <div class="sub-menu">
                    <a href="../accounting/monitor_schools.php" class="sub-item">Schools</a>
            ...
            <div class="item">
                <a class="sub-btn"><i class="fas fa-cogs"></i>Reports<i class="fas fa-angle-right dropdown"></i></a>
                <div class="sub-menu">
                    <a href="#" class="sub-item">Ledger</a>
